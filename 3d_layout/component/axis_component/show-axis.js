...
function $show_axis_Ex(selector_JQuery) {
	...
	axis = 'position: absolute;	width: 20cm; height: 5cm;background-repeat: no-repeat;background-size: 100% 100%;'
	...
	m_left = "calc(" + x0 + " - 10cm)";
	m_top = "calc(" + y0 + " - 2.5cm)"; //此处的0.5cm/3cm是坐标轴高度/宽度的一半。其高度在show-axis.css被设定
